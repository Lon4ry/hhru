    ...
    <section className="grid gap-10">
      <div className="grid items-center gap-6 rounded-3xl bg-gradient-to-r from-slate-900 to-indigo-800 px-10 py-14 text-white">
        <div className="max-w-3xl space-y-4">
          <span className="inline-flex rounded-full bg-white/10 px-4 py-1 text-xs tracking-wider uppercase">
            HR-платформа «СтаффТехнолоджи»
          </span>
          <h1 className="text-4xl leading-tight font-semibold md:text-5xl">
            Технологичный найм: соединяем лучших специалистов с амбициозными
            компаниями
          </h1>
          <p className="text-lg text-white/80">
            Публикуйте вакансии, управляйте откликами и отслеживайте аналитику —
            всё в одной экосистеме для соискателей, работодателей и
            администраторов.
          </p>
      ...
      <div className="grid gap-6 md:grid-cols-3">
        <StatsCard
          ...
          value={stats.vacancyCount}
          description="Работодатели ищут специалистов прямо сейчас"
        />
        <StatsCard
          title="Резюме в базе"
          value={stats.resumeCount}
          description="Проверенные специалисты готовы к диалогу"
        />
        <StatsCard
