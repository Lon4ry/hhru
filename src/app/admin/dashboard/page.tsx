    ...
    <div className="grid gap-6">
      <div className="grid gap-4 md:grid-cols-3">
        <StatsCard
          ...
          value={userCount}
          description="Соискатели, работодатели и администраторы"
        />
        <StatsCard
          title="Активные вакансии"
          value={activeVacancies}
          description="Мониторинг опубликованных позиций"
        />
        <StatsCard
          title="Трудоустроено"
          value={hiredCount}
          description="Статистика подтверждённых офферов"
        />
      </div>
      ...
      <Card className="space-y-4">
        <div>
          ...
          <p className="text-sm text-slate-500">
            Отслеживайте ключевые действия пользователей на платформе.
          </p>
        </div>
